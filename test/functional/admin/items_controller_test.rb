...
class Admin::ItemsControllerTest < ActionController::TestCase
  ...
  test "should create admin_item" do
    assert_difference('Admin::Item.count') do
      post :create, admin_item: { category_id: @admin_item.category_id, desc: @admin_item.desc, path: @admin_item.path, title: @admin_item.title }
    end
  ...
  test "should update admin_item" do
    put :update, id: @admin_item, admin_item: { category_id: @admin_item.category_id, desc: @admin_item.desc, path: @admin_item.path, title: @admin_item.title }
    assert_redirected_to admin_item_path(assigns(:admin_item))
  end
